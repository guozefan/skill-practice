    ...
    initBaiduMap() {
      ...
      this.$nextTick(function () {
        ...
        map.addEventListener("click", function (e) {
          ...
          const { address, district } = that.addressInfo;
          console.log(that.addressInfo)
          var local = new BMap.LocalSearch(map, { renderOptions: { map: map, panel: "searchInBounds" } });
          local.searchNearby([address, district], clickpt, 100);
        });
        /** 点击地图创建坐标事件End */
